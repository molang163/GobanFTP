...
`webdav-metadata-poison`, `webdav-href-traversal`, `dns-owner-poison`, and
`git-tree-path-metadata-poison` are also promoted into
`t/fixtures/vectors/v1-non-consensus-poison.jsonl` as public baseline/poison
golden vectors.
